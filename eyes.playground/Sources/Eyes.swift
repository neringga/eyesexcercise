...
public class Eyes : NSObject {
    ...
    @objc dynamic public class func drawEyes(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 869, height: 522),
        ...
        //// Left Eye contour 2 Drawing
        let leftEyeContour2Path = UIBezierPath()
        leftEyeContour2Path.move(to: CGPoint(x: 378.5, y: 236.41))
        leftEyeContour2Path.addCurve(to: CGPoint(x: 251.5, y: 303), controlPoint1: CGPoint(x: 378.5, y: 236.41), controlPoint2: CGPoint(x: 329.37, y: 303))
        leftEyeContour2Path.addCurve(to: CGPoint(x: 87.5, y: 236.41), controlPoint1: CGPoint(x: 173.63, y: 303), controlPoint2: CGPoint(x: 87.5, y: 254.24))
        leftEyeContour2Path.addCurve(to: CGPoint(x: 157.15, y: 187.95), controlPoint1: CGPoint(x: 87.5, y: 226.88), controlPoint2: CGPoint(x: 128.51, y: 200.03))
        leftEyeContour2Path.addCurve(to: CGPoint(x: 251.5, y: 171), controlPoint1: CGPoint(x: 182.14, y: 177.41), controlPoint2: CGPoint(x: 215.22, y: 171))
        leftEyeContour2Path.addCurve(to: CGPoint(x: 378.5, y: 236.41), controlPoint1: CGPoint(x: 329.37, y: 171), controlPoint2: CGPoint(x: 378.5, y: 236.41))
        leftEyeContour2Path.close()
        context.saveGState()
        context.setShadow(offset: CGSize(width: shadow.shadowOffset.width * resizedShadowScale, height: shadow.shadowOffset.height * resizedShadowScale), blur: shadow.shadowBlurRadius * resizedShadowScale, color: (shadow.shadowColor as! UIColor).cgColor)
        UIColor.black.setStroke()
